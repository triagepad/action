...
import type { FixPrompt, NeedsDecision } from "./types.js";

export function buildPrompts(body: string, needsDecision: NeedsDecision): FixPrompt["prompts"] {
  ...
  return {
    ...
    pr:
      `Implement this fix on a new branch and open a pull request — do not merge it.\n\n${body}${decisionNote}\n\n` +
